...
class TvShowControllerTest extends WebTestCase
{
    public function testTvShowSearch()
    {
        ...
        // je verifie que j'ai bien un seul résultat (correspond a mes fixtures)
        $this->assertCount(1, $crawler->filter('.link a'));
        $this->assertCount(1, $crawler->filter(".link > a:contains('Star')"));
